...
routerUsers.get('/', verifyRatelimiter(globalLimiter), authorize(['administrador']), async (req, res) => {
...
routerUsers.get('/:id', verifyRatelimiter(globalLimiter), authorize(['barbeiro']), async (req, res) => {
...
routerUsers.post('/create/:id_barbearia', verifyRatelimiter(registerLimiter),verifyId, async (req, res) => {
...
routerUsers.delete('/:id', verifyRatelimiter(globalLimiter),authorize(['administrador']), async (req, res) => {
...
routerUsers.patch('/:id', verifyRatelimiter(globalLimiter),authorize(['administrador']), async (req, res) => {
